...
//  Profile
//
//  Created by Khulood  on 10/11/1443 AH.
//
...
struct ProviderProfile: View {
    ...
    //@State private var profileImage = UIImage(named: "Swifts")!
...
//                    })
                    ...
                    .overlay(
                        ...
                        Button(action: {
                            ...
                            NavigationLink("", destination: ProviderEditPage(), isActive: $isShowSettingsScreen)
        ...
        ScrollView(.vertical, showsIndicators: false){
          ...
          //  Group{
                ...
                Text("About")
                        ...
                        .foregroundColor(Color.init("Color2"))
                        Spacer()
                    Capsule()
